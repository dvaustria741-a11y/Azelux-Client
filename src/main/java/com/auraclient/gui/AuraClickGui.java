...
import com.auraclient.setting.BooleanSetting;
import com.auraclient.setting.Setting;
...
public class AuraClickGui extends Screen {
    ...
    private void renderSidebar(DrawContext ctx, int mx, int my) {
        ...
        ctx.drawText(textRenderer, "\u2666 AuraClient", wx + 12, wy + 16, C_ACCENT, false);
        ...
        ctx.drawText(textRenderer, "AuraUser", wx + 36, py + 8,  C_TXT_PRI, false);
